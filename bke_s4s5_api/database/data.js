export const testElectricalEngineering = [
  {
    id: 1,
...
export const testSoftwareEngineering = [
  {
    id: 1,
    question: "Javascript soft is an _______ language",
    options: ["Object-Oriented", "Object-Based", "Procedural"],
  },
  {
    id: 2,
...
export const answersElectricalEngineering = [0, 1, 2, 1, 0];
export const answersSoftwareEngineering = [1, 2, 0, 1, 2];
